...
public class AddressBookController {
    ...
    public void control(){
            ...
            public void actionPerformed(ActionEvent e) {
                if(e.getSource()== view.getAdd())
                {
                   ...
                   view.getMainGUIFrame().disable();
                    ...
                    clexit();
                else if (e.getSource()== view.CSearch())
                    CSearch();
        ...
        view.CSearch().addActionListener(actionListener);
    ...
    private void openAdd(){   
       view.getMainGUIFrame().setVisible(false);
        ...
        choiceListener = new ActionListener() {
            ...
            String city  = contactDetailsPanel.getTxt_city().getText();
            flag = validate();
            if(flag)
            {    
   ...
   */
    ...
    private void openEdit(){
        ...
        dialog.getPanel().setcity(detailPanel.getTxt_city().getText());
        view.getMainGUIFrame().setVisible(false);
        choiceListener = new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
    ...
    public void loadPersons()       
    {
        ...
        nlp.getJList().addListSelectionListener(new ListSelectionListener()
         ...
         detailPanel.getTxt_city().setEditable(false);
        }
    }  //loadPersons ends
    public void clexit(){
        System.exit(0);
